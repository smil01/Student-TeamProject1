			...
			<div class="panel-body">
				...
				<div>
					...
					<fieldset>
						...
						<ul>
							<li>아보카도는 멕시코 중동부의 고산지대와 과테말라, 서인도 등 중앙아메리카 및 서인도제도가 원산지인
								열대성·아열대성 과일입니다. 멕시코계는 잎이나 과일에 아니스(화향풀과)와 유사한 향이 있으며 크기가 상대적으로 작고
								익는 시기가 빨라 여름부터 가을까지 수확합니다. 과테말라계와 서인도계는 아니스 향이 없는데, 서인도계는 크기가 크고
								껍질이 얇은 특징이 있습니다.</li>
							<br>
							<li>아보카도 생육 한계온도(저온)는 멕시코계 –6℃, 과테말라계 –4.5℃, 서인도계 –2.2℃ 이상
								입니다.</li>
							<br>
							<li>이들 계통 간 잡종으로 육성된 우량 품종도 있어 우리나라 기후에 맞는 품종을 선택하는 것이
								중요합니다. 아보카도는 암꽃과 수꽃의 꽃 피는 시기가 다르며 각 품종의 꽃은 크게 A형과 B형으로 구분할 수
								있습니다. 열매를 많이 달리게 하려면 A형 품종과 B형 품종을 섞어서 심을 필요가 있습니다. B형은
								제꽃가루받이(자가수분)가 가능하나 A형과 섞어 심기하는 것이 결실률이 더 높습니다.</li>
							<br>
							<li>몇 년 전부터 아열대기후의 북방한계선이 북상함에 따라 우리나라가 점차 아열대기후로 접어들고 있어
								저온에 강한 B형이나 A형 중에서도 저온에 강한 품종 또는 전 세계적으로 많이 재배되는 품종을 선택하는 것이
								유리합니다. 겨울철에는 가온이 필요하며, 하우스 가온재배 시에는 경우에 따라 A형인 “하스(Hass)” 품종을
								재배할 수도 있습니다.</li>
							<br>
						</ul>
					</fieldset>
